...
describe('Service Tests', () => {
    ...
    describe('BillOfMaterialsMc Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BillOfMaterialsMcService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/bill-of-materials';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BillOfMaterialsMc', () => {
