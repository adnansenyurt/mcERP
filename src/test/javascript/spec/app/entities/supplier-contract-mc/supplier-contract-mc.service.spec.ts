...
describe('Service Tests', () => {
    ...
    describe('SupplierContractMc Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SupplierContractMcService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/supplier-contracts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SupplierContractMc', () => {
