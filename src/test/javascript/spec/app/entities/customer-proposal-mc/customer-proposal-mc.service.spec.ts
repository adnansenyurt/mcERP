...
describe('Service Tests', () => {
    ...
    describe('CustomerProposalMc Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CustomerProposalMcService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/customer-proposals';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CustomerProposalMc', () => {
