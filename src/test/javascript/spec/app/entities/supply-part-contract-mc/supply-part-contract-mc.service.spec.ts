...
describe('Service Tests', () => {
    ...
    describe('SupplyPartContractMc Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SupplyPartContractMcService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/supply-part-contracts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SupplyPartContractMc', () => {
