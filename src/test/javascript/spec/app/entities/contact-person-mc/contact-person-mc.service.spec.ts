...
describe('Service Tests', () => {
    ...
    describe('ContactPersonMc Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ContactPersonMcService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/contact-people';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ContactPersonMc', () => {
