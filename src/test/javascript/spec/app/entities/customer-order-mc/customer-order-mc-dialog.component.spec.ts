...
describe('Component Tests', () => {
    ...
    describe('CustomerOrderMc Management Dialog Component', () => {
        let comp: CustomerOrderMcDialogComponent;
        let fixture: ComponentFixture<CustomerOrderMcDialogComponent>;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(CustomerOrderMcDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(CustomerOrderMcDialogComponent);
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new CustomerOrderMc(123);
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'customerOrderListModification', content: 'OK'});
            ...
            it('Should call create service on save for new entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new CustomerOrderMc();
