...
describe('Service Tests', () => {
    ...
    describe('CustomerOrderMc Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CustomerOrderMcService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/customer-orders';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CustomerOrderMc', () => {
