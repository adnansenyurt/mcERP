...
public class ProductResourceIntTest {
    ...
    private static final String DEFAULT_SPECS_URL = "AAAAAAAAAA";
    private static final String UPDATED_SPECS_URL = "BBBBBBBBBB";
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getBrochure()).isEqualTo(DEFAULT_BROCHURE);
        assertThat(testProduct.getSpecsURL()).isEqualTo(DEFAULT_SPECS_URL);
    }
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].brochure").value(hasItem(DEFAULT_BROCHURE.toString())))
            .andExpect(jsonPath("$.[*].specsURL").value(hasItem(DEFAULT_SPECS_URL.toString())));
    }
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.brochure").value(DEFAULT_BROCHURE.toString()))
            .andExpect(jsonPath("$.specsURL").value(DEFAULT_SPECS_URL.toString()));
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getBrochure()).isEqualTo(UPDATED_BROCHURE);
        assertThat(testProduct.getSpecsURL()).isEqualTo(UPDATED_SPECS_URL);
    }
