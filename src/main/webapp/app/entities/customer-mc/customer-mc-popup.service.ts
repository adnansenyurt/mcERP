...
@Injectable()
export class CustomerMcPopupService {
            ...
            if (id) {
                this.customerService.find(id)
                    .subscribe((customerResponse: HttpResponse<CustomerMc>) => {
                        const customer: CustomerMc = customerResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.customerModalRef(component, new CustomerMc());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    customerModalRef(component: Component, customer: CustomerMc): NgbModalRef {
