 ...
 */
@Mapper(componentModel = "spring", uses = {ContactPersonMapper.class, OpportunityMapper.class, CustomerOrderMapper.class, InvoiceMapper.class, CustomerProposalMapper.class})
